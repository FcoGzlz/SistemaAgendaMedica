    ...
    <div class="login-clean" style="height: 100%;">
        <form id="cardlogin" method="POST" action="{{ route('login')}}">
            ...
            <div class="form-group">
                <input class="form-control @error('rut') is-invalid @enderror" type="text" placeholder="Rut" name="rut" value=" {{$rut}}" style="font-family: Lato, sans-serif;" required autocomplete="rut" autofocus>
                @error('rut')
            ...
            <div class="form-group">
                <input class="form-control input-login @error('password') is-invalid @enderror" type="password" placeholder="Contraseña" name="password" style="font-family: Lato, sans-serif;" required autocomplete="current-password" autofocus>
                @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            </div><a class="forgot" href="#" style="margin-top: 10px;">He olvidado mi contraseña</a>
        </form>
    </div>
