$(function () {
    ...
    new Lightpick({
        ...
        onSelect: function (e, n) {
            let i = "";
            i += e ? e.format("Do MMMM YYYY") + " to " : "", i += n ? n.format("Do MMMM YYYY") : "...", t.value = i
        }
    })
}), $("#menu-toggle").click(function (e) {
    e.preventDefault(), $("#wrapper").toggleClass("toggled")
}), angular.module("ui.bootstrap.demo", ["ngAnimate", "ngSanitize", "ui.bootstrap"]), angular.module("ui.bootstrap.demo").controller("TimepickerDemoCtrl", function (e, t) {
    e.mytime = new Date, e.hstep = 1, e.mstep = 15, e.options = {
        ...
        t.log("Time changed to: " + e.mytime)
    }, e.clear = function () {
        e.mytime = null
    }
})

/* Inicio Script Datapicker*/

var DateFormatter, datetimepickerFactory;
!(function () {
  "use strict";
  var e, t, a, r, n;
  (e = function (e, t) {
    ...
    ((DateFormatter = function (e) {
      ...
      getMonth: function (e) {
        var t;
        return (
          0 === (t = r(e, this.dateSettings.monthsShort) + 1) &&
            (t = r(e, this.dateSettings.months) + 1),
          t
        );
      },
      ...
      guessDate: function (e, t) {
        ...
        for (n = 0; n < d.length; n++) {
          if (((f = 2), (i = d[n]), (s = parseInt(i.substr(0, 2))), isNaN(s)))
            return null;
          switch (n) {
            case 0:
          ...
          (o = i.substr(f)).length > 0 && d.splice(n + 1, 0, o);
        }
        return l;
      },
      ...
      var t = {
        ...
        i = function () {
          ...
          "function" == typeof DateFormatter &&
            (a = r = new DateFormatter({ dateSettings: e.extend({}, o, s) }));
        },
        s = {
          moment: {
            default_options: {
            ...
            formatter: {
              parseDate: function (e, t) {
                if (u(t)) return r.parseDate(e, t);
                var a = moment(e, t);
                return !!a.isValid() && a.toDate();
              },
              formatDate: function (e, t) {
                return u(t) ? r.formatDate(e, t) : moment(e).format(t);
              },
          ...
          return (
            (i = function (t) {
              var o,
                ...
                G = 0;
              C.id && A.attr("id", C.id),
                C.style && A.attr("style", C.style),
                C.weeks && A.addClass("xdsoft_showweeks"),
                C.rtl && A.addClass("xdsoft_rtl"),
                A.addClass("xdsoft_" + C.theme),
                A.addClass(C.className),
                J.find(".xdsoft_month span").after(R),
                J.find(".xdsoft_year span").after(V),
                J.find(".xdsoft_month,.xdsoft_year").on(
              ...
              function U() {
                ...
                return (
                  C.startDate
                    ...
                    : (a = C.value || (t && t.val && t.val() ? t.val() : ""))
                    ? ((a = P.strToDateTime(a)),
                      C.yearOffset &&
                        (a = new Date(
                          a.getFullYear() - C.yearOffset,
                          a.getMonth(),
                          a.getDate(),
                          a.getHours(),
                          a.getMinutes(),
                    ...
                    : C.defaultDate &&
                      ((a = P.strToDateTime(C.defaultDate)),
                      C.defaultTime &&
                        ((e = P.strtotime(C.defaultTime)),
                        a.setHours(e.getHours()),
                        a.setMinutes(e.getMinutes()))),
                  a && P.isValidDate(a) ? A.data("changed", !0) : (a = ""),
                  a || 0
                );
              }
              function X(r) {
                    ...
                    if (
                      !(e =
                        "string" == typeof e || e instanceof String
                          ? r.ownerDocument.getElementById(e)
                          : e)
                    )
                      return !1;
                ...
                r.mask && t.off("keydown.xdsoft"),
                  !0 === r.mask &&
                    (a.formatMask
                      ? (r.mask = a.formatMask(r.format))
                      : (r.mask = r.format
                          .replace(/Y/g, "9999")
                          .replace(/F/g, "9999")
                          .replace(/m/g, "19")
                          ...
                          .replace(/i/g, "59")
                          .replace(/s/g, "59"))),
                  "string" === e.type(r.mask) &&
                    (n(r.mask, t.val()) ||
                      (t.val(r.mask.replace(/[0-9]/g, "_")), o(t[0], 0)),
                    t.on("paste.xdsoft", function (a) {
                      ...
                      return (
                        ...
                        n(r.mask, s)
                          ...
                          : "" === e.trim(s)
                          ? (this.value = r.mask.replace(/[0-9]/g, "_"))
                    ...
                    t.on("keydown.xdsoft", function (a) {
                      ...
                      if (
                        ...
                        if ("" === e.trim(s)) s = J;
                        else if (l === r.mask.length)
                          return a.preventDefault(), !1;
                        for (
                          l += d === y ? 0 : 1;
                          /[^0-9_]/.test(r.mask.substr(l, 1)) &&
                          l < r.mask.length &&
                          l > 0;
                        ...
                        n(r.mask, s)
                          ...
                          ? (this.value = r.mask.replace(/[0-9]/g, "_"))
                          : t.trigger("error_input.xdsoft");
                      } else if ((-1 !== [M, O, w, W, _].indexOf(d) && F) || -1 !== [D, k, x, v, b, S, h, T, p].indexOf(d)) return !0;
                      return a.preventDefault(), !1;
                    }));
              }
              J.find(".xdsoft_select")
                .xdsoftScroller(C)
                  ...
                  if (!this.touchMoved) {
                    ...
                    P &&
                      ...
                      C.onChangeMonth &&
                        ...
                        C.onChangeMonth.call(A, P.currentTime, A.data("input")),
                      t !== P.currentTime.getFullYear() &&
                        e.isFunction(C.onChangeYear) &&
                        C.onChangeYear.call(A, P.currentTime, A.data("input"));
                  }
                }),
                (A.getValue = function () {
                ...
                (A.setOptions = function (r) {
                  ...
                  (C = e.extend(!0, {}, C, r)),
                    ...
                    r.highlightedDates &&
                      ...
                      (e.each(r.highlightedDates, function (t, r) {
                        var o,
                          i = e.map(r.split(","), e.trim),
                          s = new l(
                            a.parseDate(i[0], C.formatDate),
                            i[1],
                            i[2]
                          ),
                          d = a.formatDate(s.date, C.formatDate);
                        void 0 !== n[d]
                          ? (o = n[d].desc) &&
                            o.length &&
                            s.desc &&
                    ...
                    r.highlightedPeriods &&
                      ...
                      e.each(r.highlightedPeriods, function (t, r) {
                        var o, i, s, d, u, f, c;
                        if (e.isArray(r))
                          (o = r[0]), (i = r[1]), (s = r[2]), (c = r[3]);
                        else {
                          var m = e.map(r.split(","), e.trim);
                          (o = a.parseDate(m[0], C.formatDate)),
                            (i = a.parseDate(m[1], C.formatDate)),
                            (s = m[2]),
                            (c = m[3]);
                        }
                        for (; o <= i; )
                          (d = new l(o, s, c)),
                            (u = a.formatDate(o, C.formatDate)),
                    ...
                    C.value &&
                      (P.setCurrentTime(C.value), t && t.val && t.val(P.str)),
                    isNaN(C.dayOfWeekStart)
                      ? (C.dayOfWeekStart = 0)
                      : (C.dayOfWeekStart = parseInt(C.dayOfWeekStart, 10) % 7),
                    C.timepickerScrollbar || I.xdsoftScroller(C, "hide"),
                    C.minDate &&
                      /^[\+\-](.*)$/.test(C.minDate) &&
                      (C.minDate = a.formatDate(
                        P.strToDateTime(C.minDate),
                        C.formatDate
                      )),
                    C.maxDate &&
                      /^[\+\-](.*)$/.test(C.maxDate) &&
                      (C.maxDate = a.formatDate(
                        P.strToDateTime(C.maxDate),
                        C.formatDate
                      )),
                    C.minDateTime &&
                      /^\+(.*)$/.test(C.minDateTime) &&
                      (C.minDateTime = P.strToDateTime(
                        C.minDateTime
                      ).dateFormat(C.formatDate)),
                    C.maxDateTime &&
                      /^\+(.*)$/.test(C.maxDateTime) &&
                      (C.maxDateTime = P.strToDateTime(
                        C.maxDateTime
                      ).dateFormat(C.formatDate)),
                    E.toggle(C.showApplyButton),
                    ...
                    C.validateOnBlur &&
                      t.off("blur.xdsoft").on("blur.xdsoft", function () {
                        if (
                          ...
                          e(this).val(null), A.data("xdsoft_datetime").empty();
                        else {
                          ...
                          if (t) e(this).val(a.formatDate(t, C.format));
                            ...
                            n < 60
                              ...
                              : e(this).val(a.formatDate(P.now(), C.format));
                          }
                          A.data("xdsoft_datetime").setCurrentTime(
                            e(this).val()
                          );
                        }
                ...
                A.append(j).append(N),
                !0 !== C.withoutCopyright && A.append(H),
                j.append(J).append(z).append(E),
                C.insideParent
                  ? e(t).parent().append(A)
                  : e(C.parentID).append(A),
                (P = new (function () {
                  var t = this;
                  (t.now = function (e) {
                    var a,
                    ...
                    (t.strToDateTime = function (e) {
                      ...
                      return e && e instanceof Date && t.isValidDate(e)
                        ? e
                        : ((o = /^([+-]{1})(.*)$/.exec(e)) &&
                            (o[2] = a.parseDate(o[2], C.formatDate)),
                          o && o[2]
                            ? ((r =
                                o[2].getTime() -
                            ...
                            : (n = e ? a.parseDate(e, C.format) : t.now()),
                ...
                J.find(".xdsoft_today_button")
                  .on("touchend mousedown.xdsoft", function () {
                    A.data("changed", !0),
                      P.setCurrentTime(0, !0),
                      A.trigger("afterOpen.xdsoft");
                  })
                ...
                J.find(".xdsoft_prev,.xdsoft_next").on(
                    ...
                    !(function e(o) {
                      ...
                      s - i - C.timeHeightInTimePicker >= d
                        ...
                        I.trigger("scroll_element.xdsoft_scroller", [
                          Math.abs(
                            parseInt(L[0].style.marginTop, 10) / (s - i)
                          ),
                        ]),
                        (n = n > 10 ? 10 : n - 10),
                ...
                (o = 0),
                A.on("xchange.xdsoft", function (i) {
                  clearTimeout(o),
                    (o = setTimeout(function () {
                      ...
                      for (
                        ...
                        g +=
                          "<th>" +
                          C.i18n[n].dayOfWeekShort[(o + C.dayOfWeekStart) % 7] +
                          "</th>";
                      for (
                        g += "</tr></thead>",
                          g += "<tbody>",
                          !1 !== C.maxDate &&
                            ((v = P.strToDate(C.maxDate)),
                            (v = new Date(
                              v.getFullYear(),
                              v.getMonth(),
                              v.getDate(),
                          ...
                          !1 !== x &&
                            (h =
                              ...
                              x.getDate());
                        D < P.currentTime.countDaysInMonth() ||
                        p.getDay() !== C.dayOfWeekStart ||
                        P.currentTime.getMonth() === p.getMonth();
                        ...
                        (T = []),
                          ...
                          (f =
                            C.beforeShowDay &&
                            e.isFunction(C.beforeShowDay.call)
                              ? C.beforeShowDay.call(A, p)
                              : null),
                          C.allowDateRe &&
                            "[object RegExp]" ===
                              Object.prototype.toString.call(C.allowDateRe) &&
                            (C.allowDateRe.test(
                              a.formatDate(p, C.formatDate)
                            ) ||
                        ...
                        ((!1 !== v && p > v) ||
                          ...
                          f && "" !== f[1] && T.push(f[1]),
                          P.currentTime.getMonth() !== F &&
                            T.push("xdsoft_other_month"),
                          (C.defaultSelect || A.data("changed")) &&
                            a.formatDate(P.currentTime, C.formatDate) ===
                              a.formatDate(p, C.formatDate) &&
                            T.push("xdsoft_current"),
                          a.formatDate(y, C.formatDate) ===
                            a.formatDate(p, C.formatDate) &&
                            T.push("xdsoft_today"),
                          (0 !== p.getDay() &&
                            6 !== p.getDay() &&
                          ...
                          void 0 !==
                            C.highlightedDates[a.formatDate(p, C.formatDate)] &&
                            ((i =
                              C.highlightedDates[
                                a.formatDate(p, C.formatDate)
                              ]),
                      ...
                      (g += "</tbody></table>"),
                        z.html(g),
                        J.find(".xdsoft_label span")
                          .eq(0)
                          .text(C.i18n[n].months[P.currentTime.getMonth()]),
                        J.find(".xdsoft_label span")
                          .eq(1)
                      ...
                      if (!1 !== C.minDateTime) {
                        ...
                        if (
                          a.formatDate(P.currentTime, C.formatDate) ===
                          a.formatDate(W, C.formatDate)
                        )
                          (F = 60 * W.getHours() + W.getMinutes()) > w &&
                            (w = F);
                      }
                      if (!1 !== C.maxDateTime) {
                        var F;
                        ...
                        if (
                          ...
                          (F = 60 * W.getHours() + W.getMinutes()) < _ &&
                            (_ = F);
                      }
                      if (
                        ((c = function (r, n) {
                          var o,
                            ...
                            s =
                              ...
                              C.allowTimes.length;
                          i.setHours(r),
                            (r = parseInt(i.getHours(), 10)),
                            i.setMinutes(n),
                            (n = parseInt(i.getMinutes(), 10)),
                            (T = []);
                          var d = 60 * r + n;
                          (t.is("[disabled]") || d >= _ || d < w) &&
                            T.push("xdsoft_disabled"),
                            ...
                            s ||
                              o.setMinutes(
                                Math[C.roundTime](
                                  P.currentTime.getMinutes() / C.step
                                ) * C.step
                              ),
                            (C.initTime ||
                              C.defaultSelect ||
                              A.data("changed")) &&
                              o.getHours() === parseInt(r, 10) &&
                              ((!s && C.step > 59) ||
                                o.getMinutes() === parseInt(n, 10)) &&
                              (C.defaultSelect || A.data("changed")
                                ? T.push("xdsoft_current")
                                : C.initTime && T.push("xdsoft_init_time")),
                            parseInt(y.getHours(), 10) === parseInt(r, 10) &&
                        ...
                        for (D = 0; D < C.allowTimes.length; D += 1)
                          c(
                            P.strtotime(C.allowTimes[D]).getHours(),
                            (F = P.strtotime(C.allowTimes[D]).getMinutes())
                          );
                      else
                      ...
                      for (
                        L.html(M), r = "", D = parseInt(C.yearStart, 10);
                        D <= parseInt(C.yearEnd, 10);
                        D += 1
                      )
                        r +=
                          '<div class="xdsoft_option ' +
                          (P.currentTime.getFullYear() === D
                            ? "xdsoft_current"
                            : "") +
                          '" data-value="' +
                          D +
                      ...
                      for (
                        ...
                        r +=
                          ...
                          C.i18n[n].months[D] +
                          "</div>";
                      R.children().eq(0).html(r),
                        e(A).trigger("generate.xdsoft");
                    }, 10)),
                    i.stopPropagation();
                  ...
                  C.timepicker &&
                    (L.find(".xdsoft_current").length
                      ? (e = ".xdsoft_current")
                      : L.find(".xdsoft_init_time").length &&
                        (e = ".xdsoft_init_time"),
                    e
                      ? ((t = I[0].clientHeight),
                        (a = L[0].offsetHeight) - t <
                          (r =
                            L.find(e).index() * C.timeHeightInTimePicker + 1) &&
                          (r = a - t),
                        I.trigger("scroll_element.xdsoft_scroller", [
                          parseInt(r, 10) / (a - t),
                        ]))
                ...
                (i = 0),
                z.on("touchend click.xdsoft", "td", function (a) {
                  ...
                  n.setDate(1),
                    ...
                    A.trigger("select.xdsoft", [n]),
                    t.val(P.str()),
                    C.onSelectDate &&
                      e.isFunction(C.onSelectDate) &&
                      C.onSelectDate.call(A, P.currentTime, A.data("input"), a),
                    A.data("changed", !0),
                    A.trigger("xchange.xdsoft"),
                    A.trigger("changedatetime.xdsoft"),
                    (i > 1 ||
                ...
                L.on("touchstart", "div", function (e) {
                  ...
                  .on("touchend click.xdsoft", "div", function (t) {
                    if (!this.touchMoved) {
                      ...
                      if (
                        (null == r &&
                          ((P.currentTime = P.now()), (r = P.currentTime)),
                        a.hasClass("xdsoft_disabled"))
                      )
                        return !1;
                      r.setHours(a.data("hour")),
                        r.setMinutes(a.data("minute")),
                        A.trigger("select.xdsoft", [r]),
                        A.data("input").val(P.str()),
                        C.onSelectTime &&
                ...
                t.on("mousewheel.xdsoft", function (e) {
                  return (
                    ...
                    (!C.datepicker && C.timepicker
                      ? ((s = L.find(".xdsoft_current").length
                          ? L.find(".xdsoft_current").eq(0).index()
                          : 0) +
                          e.deltaY >=
                          0 &&
                          s + e.deltaY < L.children().length &&
                          (s += e.deltaY),
                        L.children().eq(s).length &&
                          L.children().eq(s).trigger("mousedown"),
                        !1)
                      : C.datepicker && !C.timepicker
                ...
                A.on("changedatetime.xdsoft", function (t) {
                  if (C.onChangeDateTime && e.isFunction(C.onChangeDateTime)) {
                    var a = A.data("input");
                    C.onChangeDateTime.call(A, P.currentTime, a, t),
                      delete C.value,
                      a.trigger("change");
                  }
                })
                  .on("generate.xdsoft", function () {
                    C.onGenerate &&
                      ...
                      C.onGenerate.call(A, P.currentTime, A.data("input")),
                      B && (A.trigger("afterOpen.xdsoft"), (B = !1));
                  })
                  ...
                  "rtl" === d.parent().css("direction") &&
                        ...
                        s && !C.insideParent
                          ? ((o = "fixed"),
                            r + A.outerHeight() > c + m
                              ...
                              : (r -= m))
                          : r + A[0].offsetHeight > c + m &&
                            (r = t.top - A[0].offsetHeight + 1),
                        r < 0 && (r = 0),
                    ...
                    Y(i, function (e) {
                      if (
                        ...
                        return (n -= (u - e.offsetWidth) / 2), !1;
                    }),
                    (f = {
                      position: o,
                      left: C.insideParent ? a.offsetLeft : n,
                      top: "",
                      bottom: "",
                    }),
                    C.insideParent
                ...
                A.on("open.xdsoft", function (t) {
                  ...
                  C.onShow &&
                    ...
                    (a = C.onShow.call(A, P.currentTime, A.data("input"), t)),
                    !1 !== a &&
                      (A.show(),
                      d(),
                      e(C.contentWindow)
                  ...
                  .on("close.xdsoft", function (t) {
                    var a = !0;
                    J.find(".xdsoft_month,.xdsoft_year")
                      .find(".xdsoft_select")
                      .hide(),
                      C.onClose &&
                      ...
                      (this.value = this.defaultValue),
                        (this.value &&
                          n
                            ...
                            .isValidDate(a.parseDate(this.value, C.format))) ||
                          n.data("changed", !1),
  ...
  (function (e) {
    ...
    var s = (e.event.special.mousewheel = {
      ...
      setup: function () {
        if (this.addEventListener)
          for (var t = n.length; t; ) this.addEventListener(n[--t], d, !1);
      ...
      teardown: function () {
        if (this.removeEventListener)
          for (var t = n.length; t; ) this.removeEventListener(n[--t], d, !1);
    ...
    function d(r) {
      ...
      if (
        ...
        if (
          ((n = Math.max(Math.abs(m), Math.abs(c))),
          (!a || n < a) && ((a = n), l(i, n) && (a /= 40)),
          l(i, n) && ((f /= 40), (c /= 40), (m /= 40)),
      ...
      ((DateFormatter = function (e) {
        ...
        guessDate: function (e, t) {
          ...
          for (n = 0; n < d.length; n++) {
            ...
            switch (n) {
              ...
              case 2:
                if (
                  ...
                  (f = (a = i.length) < 4 ? a : 4),
                  !(r = parseInt(
                    a < 4 ? r.toString().substr(0, 4 - a) + i : i.substr(0, 4)
                  )))
                )
                  return null;
                l.setFullYear(r);
            ...
            0 < (o = i.substr(f)).length && d.splice(n + 1, 0, o);
          }
          return l;
        },
        parseFormat: function (e, a) {
          ...
          return (
            (i = function (t) {
              ...
              var L = function (e) {
                ...
                var r = Math.abs(this.touchStartPosition.clientX - a.clientX),
                  n = Math.abs(this.touchStartPosition.clientY - a.clientY);
                Math.sqrt(r * r + n * n) > M.touchMovedThreshold &&
                  (this.touchMoved = !0);
              };
              function E() {
                var e,
                ...
                return (
                  M.startDate
                    ...
                    : M.defaultDate &&
                      ((a = O.strToDateTime(M.defaultDate)),
                      M.defaultTime &&
                        ((e = O.strtotime(M.defaultTime)),
                        a.setHours(e.getHours()),
                        a.setMinutes(e.getMinutes()))),
                  a && O.isValidDate(a) ? W.data("changed", !0) : (a = ""),
                  a || 0
                );
              }
              function R(r) {
                    ...
                    t.on("keydown.xdsoft", function (a) {
                      ...
                      if (
                        ...
                        for (
                          ...
                          var w = r.mask.substr(l, 1),
                            W = l < r.mask.length,
                            _ = 0 < l;
                          if (!(/[^0-9_]/.test(w) && W && _)) break;
                          l += 8 !== d || O ? 1 : -1;
                        }
                        if ((a.metaKey && (O = !(l = 0)), O)) {
                          var F = M - l,
                            C = r.mask.replace(/[0-9]/g, "_"),
                        ...
                        n(r.mask, s)
                          ...
                          ? (this.value = r.mask.replace(/[0-9]/g, "_"))
                          : t.trigger("error_input.xdsoft");
                      } else if ((-1 !== [v, k, b, x, T].indexOf(d) && S) || -1 !== [c, h, p, m, g, y, u, D, f].indexOf(d)) return !0;
                      return a.preventDefault(), !1;
                    }));
              }
              C.find(".xdsoft_select")
                ...
                .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
                  if (!this.touchMoved) {
                    (void 0 !== O.currentTime && null !== O.currentTime) ||
                      (O.currentTime = O.now());
                    var t = O.currentTime.getFullYear();
                    O &&
                      O.currentTime &&
                      O.currentTime[
                        e(this).parent().parent().hasClass("xdsoft_monthselect")
                      ...
                      M.onChangeMonth &&
                        ...
                        M.onChangeMonth.call(W, O.currentTime, W.data("input")),
                      t !== O.currentTime.getFullYear() &&
                        e.isFunction(M.onChangeYear) &&
                        M.onChangeYear.call(W, O.currentTime, W.data("input"));
                  }
                }),
                (W.getValue = function () {
                  return O.getCurrentTime();
                }),
                (W.setOptions = function (r) {
                  var n = {};
                  (M = e.extend(!0, {}, M, r)),
                    r.allowTimes &&
                      e.isArray(r.allowTimes) &&
                      r.allowTimes.length &&
                      (M.allowTimes = e.extend(!0, [], r.allowTimes)),
                    r.weekends &&
                      e.isArray(r.weekends) &&
                      r.weekends.length &&
                      (M.weekends = e.extend(!0, [], r.weekends)),
                    r.allowDates &&
                      e.isArray(r.allowDates) &&
                      r.allowDates.length &&
                      (M.allowDates = e.extend(!0, [], r.allowDates)),
                    r.allowDateRe &&
                      "[object String]" ===
                        Object.prototype.toString.call(r.allowDateRe) &&
                      (M.allowDateRe = new RegExp(r.allowDateRe)),
                    r.highlightedDates &&
                      e.isArray(r.highlightedDates) &&
                      r.highlightedDates.length &&
                      (e.each(r.highlightedDates, function (t, r) {
                      ...
                      (M.highlightedDates = e.extend(!0, [], n))),
                    r.highlightedPeriods &&
                      e.isArray(r.highlightedPeriods) &&
                      r.highlightedPeriods.length &&
                      ((n = e.extend(!0, [], M.highlightedDates)),
                      e.each(r.highlightedPeriods, function (t, r) {
                        var o, i, s, d, u, f, c;
                        if (e.isArray(r))
                          (o = r[0]), (i = r[1]), (s = r[2]), (c = r[3]);
                    ...
                    r.disabledDates &&
                      e.isArray(r.disabledDates) &&
                      r.disabledDates.length &&
                      (M.disabledDates = e.extend(!0, [], r.disabledDates)),
                    r.disabledWeekDays &&
                      e.isArray(r.disabledWeekDays) &&
                      r.disabledWeekDays.length &&
                    ...
                    M.value &&
                      (O.setCurrentTime(M.value), t && t.val && t.val(O.str)),
                    ...
                    M.minDate &&
                      ...
                      (M.minDate = a.formatDate(
                        O.strToDateTime(M.minDate),
                        M.formatDate
                      )),
                    M.maxDate &&
                      /^[\+\-](.*)$/.test(M.maxDate) &&
                      (M.maxDate = a.formatDate(
                        O.strToDateTime(M.maxDate),
                        M.formatDate
                      )),
                    M.minDateTime &&
                      /^\+(.*)$/.test(M.minDateTime) &&
                      (M.minDateTime = O.strToDateTime(
                        M.minDateTime
                      ).dateFormat(M.formatDate)),
                    M.maxDateTime &&
                      /^\+(.*)$/.test(M.maxDateTime) &&
                      (M.maxDateTime = O.strToDateTime(
                        M.maxDateTime
                      ).dateFormat(M.formatDate)),
                        ...
                        if (
                          ...
                          if (t) e(this).val(a.formatDate(t, M.format));
                            ...
                            n < 60
                              ...
                              : e(this).val(a.formatDate(O.now(), M.format));
                          }
                          W.data("xdsoft_datetime").setCurrentTime(
                            e(this).val()
                          );
                        }
                ...
                (O = new (function () {
                  ...
                  (t.now = function (e) {
                    ...
                    (t.strToDate = function (e) {
                      if (e && e instanceof Date && t.isValidDate(e)) return e;
                      var r = e ? a.parseDate(e, M.formatDate) : t.now(!0);
                      return t.isValidDate(r) || (r = t.now(!0)), r;
                    }),
                    (t.strtotime = function (e) {
                      if (e && e instanceof Date && t.isValidDate(e)) return e;
                      var r = e ? a.parseDate(e, M.formatTime) : t.now(!0);
                      return t.isValidDate(r) || (r = t.now(!0)), r;
                    }),
                    (t.str = function () {
                      var e = M.format;
                    ...
                    !(function e(o) {
                      ...
                      s - i - M.timeHeightInTimePicker >= d
                        ...
                        A.trigger("scroll_element.xdsoft_scroller", [
                          Math.abs(
                            parseInt(H[0].style.marginTop, 10) / (s - i)
                          ),
                        ]),
                        (n = 10 < n ? 10 : n - 10),
                        r || (a = setTimeout(e, o || n));
                    ...
                    (o = setTimeout(function () {
                      ...
                      for (
                        var o,
                          ...
                          g = "",
                          p = new Date(
                            O.currentTime.getFullYear(),
                            O.currentTime.getMonth(),
                            1,
                            12,
                            0,
                            0
                      ...
                      for (
                        ...
                        g +=
                          "<th>" +
                          M.i18n[n].dayOfWeekShort[(o + M.dayOfWeekStart) % 7] +
                          "</th>";
                      for (
                        g += "</tr></thead>",
                          g += "<tbody>",
                          !1 !== M.maxDate &&
                            ((v = O.strToDate(M.maxDate)),
                            (v = new Date(
                              v.getFullYear(),
                              v.getMonth(),
                              v.getDate(),
                          ...
                          !1 !== x &&
                            (h =
                              31 * (12 * x.getFullYear() + x.getMonth()) +
                              x.getDate());
                        D < O.currentTime.countDaysInMonth() ||
                        p.getDay() !== M.dayOfWeekStart ||
                        O.currentTime.getMonth() === p.getMonth();
                        ...
                        (T = []),
                          ...
                          (f =
                            M.beforeShowDay &&
                            e.isFunction(M.beforeShowDay.call)
                        ...
                        ((!1 !== v && v < p) ||
                          ...
                          t.is("[disabled]") && T.push("xdsoft_disabled"),
                          f && "" !== f[1] && T.push(f[1]),
                          O.currentTime.getMonth() !== j &&
                            T.push("xdsoft_other_month"),
                          (M.defaultSelect || W.data("changed")) &&
                            a.formatDate(O.currentTime, M.formatDate) ===
                              a.formatDate(p, M.formatDate) &&
                            T.push("xdsoft_current"),
                      ...
                      (g += "</tbody></table>"),
                        ...
                        C.find(".xdsoft_label span")
                          .eq(0)
                          .text(M.i18n[n].months[O.currentTime.getMonth()]),
                        C.find(".xdsoft_label span")
                          .eq(1)
                          .text(O.currentTime.getFullYear() + M.yearOffset),
                        (j = w = "");
                      var F = 0;
                      if (!1 !== M.minTime) {
                        var Y = O.strtotime(M.minTime);
                        F = 60 * Y.getHours() + Y.getMinutes();
                      }
                      var A = 1440;
                      if (
                        (!1 !== M.maxTime &&
                          ((Y = O.strtotime(M.maxTime)),
                          (A = 60 * Y.getHours() + Y.getMinutes())),
                        !1 !== M.minDateTime &&
                          ((Y = O.strToDateTime(M.minDateTime)),
                          a.formatDate(O.currentTime, M.formatDate) ===
                            a.formatDate(Y, M.formatDate)))
                      ) {
                      ...
                      if (
                        (!1 !== M.maxDateTime &&
                          ((Y = O.strToDateTime(M.maxDateTime)),
                          a.formatDate(O.currentTime, M.formatDate) ===
                            a.formatDate(Y, M.formatDate) &&
                        ...
                        (c = function (r, n) {
                          ...
                          (t.is("[disabled]") || A <= d || d < F) &&
                            T.push("xdsoft_disabled"),
                            (o = new Date(O.currentTime)).setHours(
                              parseInt(O.currentTime.getHours(), 10)
                            ),
                            s ||
                              o.setMinutes(
                                Math[M.roundTime](
                                  O.currentTime.getMinutes() / M.step
                                ) * M.step
                              ),
                            (M.initTime ||
                              M.defaultSelect ||
                        ...
                        for (D = 0; D < M.allowTimes.length; D += 1)
                          c(
                            O.strtotime(M.allowTimes[D]).getHours(),
                            (j = O.strtotime(M.allowTimes[D]).getMinutes())
                          );
                      else
                      ...
                      for (
                        H.html(w), r = "", D = parseInt(M.yearStart, 10);
                        D <= parseInt(M.yearEnd, 10);
                        D += 1
                      )
                        r +=
                          '<div class="xdsoft_option ' +
                          (O.currentTime.getFullYear() === D
                            ? "xdsoft_current"
                            : "") +
                          '" data-value="' +
                          D +
                    ...
                    e
                      ? ((t = A[0].clientHeight),
                        (a = H[0].offsetHeight) - t <
                          (r =
                            H.find(e).index() * M.timeHeightInTimePicker + 1) &&
                          (r = a - t),
                        A.trigger("scroll_element.xdsoft_scroller", [
                          parseInt(r, 10) / (a - t),
                        ]))
                ...
                P.on("touchend click.xdsoft", "td", function (a) {
                  ...
                  if (
                    (null == n &&
                      ((O.currentTime = O.now()), (n = O.currentTime)),
                    r.hasClass("xdsoft_disabled"))
                  )
                    return !1;
                  n.setDate(1),
                    ...
                    M.onSelectDate &&
                      ...
                      M.onSelectDate.call(W, O.currentTime, W.data("input"), a),
                    W.data("changed", !0),
                    W.trigger("xchange.xdsoft"),
                    W.trigger("changedatetime.xdsoft"),
                    (1 < i ||
                ...
                H.on("touchstart", "div", function (e) {
                  ...
                  .on("touchend click.xdsoft", "div", function (t) {
                    if (!this.touchMoved) {
                      ...
                      if (
                        (null == r &&
                          ((O.currentTime = O.now()), (r = O.currentTime)),
                        a.hasClass("xdsoft_disabled"))
                      )
                        return !1;
                      r.setHours(a.data("hour")),
                ...
                F.on("mousewheel.xdsoft", function (e) {
                  return (
                    !M.scrollMonth ||
                    (e.deltaY < 0 ? O.nextMonth() : O.prevMonth(), !1)
                  );
                }),
                t.on("mousewheel.xdsoft", function (e) {
                  return (
                ...
                W.on("changedatetime.xdsoft", function (t) {
                  if (M.onChangeDateTime && e.isFunction(M.onChangeDateTime)) {
                    var a = W.data("input");
                    M.onChangeDateTime.call(W, O.currentTime, a, t),
                      delete M.value,
                      a.trigger("change");
                  }
                })
                  .on("generate.xdsoft", function () {
                    M.onGenerate &&
                      ...
                      M.onGenerate.call(W, O.currentTime, W.data("input")),
                ...
                (d = function () {
                  ...
                  "rtl" === d.parent().css("direction") &&
                    (n -= W.outerWidth() - d.outerWidth()),
                    M.fixed
                      ? ((r -= m),
                        (n -= e(M.contentWindow).scrollLeft()),
                        (o = "fixed"))
                      : ((s = !1),
                        w(a, function (e) {
                          return (
                        ...
                        s && !M.insideParent
                          ? ((o = "fixed"),
                            r + W.outerHeight() > c + m
                              ? ((l = "bottom"), (r = c + m - t.top))
                              : (r -= m))
                          : r + W[0].offsetHeight > c + m &&
                            (r = t.top - W[0].offsetHeight + 1),
                        r < 0 && (r = 0),
                        n + a.offsetWidth > u && (n = u - a.offsetWidth)),
                    (i = W[0]),
                    w(i, function (e) {
                    ...
                    (f = {
                      position: o,
                      left: M.insideParent ? a.offsetLeft : n,
                      top: "",
                      bottom: "",
                    }),
                    M.insideParent
                ...
                W.on("open.xdsoft", function (t) {
                  ...
                  M.onShow &&
                    ...
                    (a = M.onShow.call(W, O.currentTime, W.data("input"), t)),
                    !1 !== a &&
                      (W.show(),
                      d(),
                      e(M.contentWindow)
                ...
                t
                  ...
                  .on("keydown.xdsoft", function (t) {
                    var a,
                      r = t.which;
                    return -1 !== [f].indexOf(r) && M.enterLikeTab
                      ? ((a = e(
                          "input:visible,textarea:visible,button:visible,a:visible"
                        )),
                        W.trigger("close.xdsoft"),
